...
pub struct V1TokensList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::TokenInfoResponse>,
}

impl V1TokensList200Response {
    pub fn new(count: i32, results: Vec<crate::models::TokenInfoResponse>) -> V1TokensList200Response {
