...
pub struct V1SafesMessagesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::SafeMessageResponse>,
}

impl V1SafesMessagesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::SafeMessageResponse>) -> V1SafesMessagesList200Response {
