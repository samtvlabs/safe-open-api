...
impl SafeMultisigTransactionResponse {
    pub fn new(safe: String, to: String, value: String, operation: i32, safe_tx_gas: i32, base_gas: i32, gas_price: String, nonce: i32, execution_date: String, submission_date: String, modified: String, transaction_hash: String, safe_tx_hash: String, is_executed: bool, confirmations_required: i32, trusted: bool) -> SafeMultisigTransactionResponse {
