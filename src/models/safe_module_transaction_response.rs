...
pub struct SafeModuleTransactionResponse {
...
impl SafeModuleTransactionResponse {
    pub fn new(execution_date: String, safe: String, module: String, to: String, value: String, data: Option<String>, operation: i32) -> SafeModuleTransactionResponse {
